...
<body>
  ...
  <div class="modal-backdrop" id="nameGate">
      ...
      <p class="file-meta">Cuéntame tu nombre para saludarte mejor y recordar el hilo de tus respuestas durante la conversación.</p>
...
class AppHandler(BaseHTTPRequestHandler):
    ...
    def handle_ask(self) -> None:
        ...
        if not user_name:
            json_response(self, {"ok": False, "message": "Primero escribe tu nombre para personalizar la conversacion."}, status=400)
            return
        if not question:
